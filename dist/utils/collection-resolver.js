...
export class CollectionResolver {
     ...
     */
    async resolveCollection(input, defaultCollectionId) {
        ...
        for (const site of this.sites) {
            ...
            for (const collection of siteCollections) {
                ...
                // Partial word matches
                    ...
                    const matchingWords = collectionWords.filter(word => inputWords.some(inputWord => inputWord.includes(word) || word.includes(inputWord)));
