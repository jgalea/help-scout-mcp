...
export class HelpScoutAPIConstraints {
     ...
     */
    static validateToolCall(context) {
     ...
     */
    static validateSearchConversations(args, userQuery, previousCalls) {
        const errors = [];
        const suggestions = [];
     ...
     */
    static validateConversationSummary(args) {
        const errors = [];
        const suggestions = [];
     ...
     */
    static validateGetThreads(args) {
        const errors = [];
        const suggestions = [];
        if (!args.conversationId || typeof args.conversationId !== 'string') {
            errors.push('conversationId is required');
     ...
     */
    static validateCreateReply(args) {
        const errors = [];
        const suggestions = [];
        if (!args.conversationId || typeof args.conversationId !== 'string') {
            errors.push('conversationId is required');
     ...
     */
    static validateGetConversation(args) {
        const errors = [];
        const suggestions = [];
        if (!args.conversationId || typeof args.conversationId !== 'string') {
            errors.push('conversationId is required');
     ...
     */
    static validateCreateConversation(args) {
        const errors = [];
        const suggestions = [];
        if (!args.subject || typeof args.subject !== 'string') {
            errors.push('subject is required');
        }
        if (!args.type || !['email', 'phone', 'chat'].includes(args.type)) {
     ...
     */
    static validateUpdateConversation(args) {
        const errors = [];
        const suggestions = [];
        if (!args.conversationId || typeof args.conversationId !== 'string') {
            errors.push('conversationId is required');
     ...
     */
    static detectInboxMention(userQuery) {
        const inboxKeywords = [
     ...
     */
    static generateToolGuidance(toolName, result, _context) {
        const guidance = [];
...
//# sourceMappingURL=api-constraints.js.map