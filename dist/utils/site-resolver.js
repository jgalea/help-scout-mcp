...
export class SiteResolver {
     ...
     */
    async resolveSite(input, defaultSiteId) {
        ...
        for (const site of this.sites) {
            ...
            // Partial word matches
                ...
                const matchingWords = siteWords.filter(word => inputWords.some(inputWord => inputWord.includes(word) || word.includes(inputWord)));
